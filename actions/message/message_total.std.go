...
func (*MessageTotalAction) PageByCond(args *action.PageByCond, reply *action.PageByCond) error {
	...
	var err error
	reply.CurrentSize, err = o.QueryTable("message_total").SetCond(cond).OrderBy(args.OrderBy...).Limit(args.PageSize, (args.Current-1)*args.PageSize).All(&reply.List, args.Cols...)
